...
export default {
  ...
  moduleNameMapper: {
    ...
    "^@continuedev/config-yaml$": "<rootDir>/../packages/config-yaml/dist/index.js",
    "^@continuedev/fetch$": "<rootDir>/../packages/fetch/dist/index.js",
    "^@continuedev/llm-info$": "<rootDir>/../packages/llm-info/dist/index.js",
    "^@continuedev/openai-adapters$": "<rootDir>/../packages/openai-adapters/dist/index.js",
    "^@continuedev/terminal-security$": "<rootDir>/../packages/terminal-security/dist/index.js",
  },
