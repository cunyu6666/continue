...
vLLM supports custom thinking output formats using configurable tags. This allows models to emit reasoning content that is displayed separately from the main response.

To configure custom thinking tags:
...
See the [vLLM documentation](https://docs.vllm.ai/en/latest/features/reasoning_outputs.html) for more details on reasoning outputs.
